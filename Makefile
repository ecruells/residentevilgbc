...
# sprites_png = $(wildcard gfx/*.png, gfx/room_items_sprites/*.png)
...
# $(sprites_2bpp):
# 	python tools/sprite_tools/png2bpp.py -m png2bpp -i $(patsubst %.2bpp,%.png,$@) -o $@

# $(sprt_sheets_2bpp):
# 	python tools/sprite_tools/png2bpp.py -m interlacedpairs -i $(patsubst %.2bpp,%.png,$@) -o $@
