...
;idle
	dw BANK(yawn_front_spritesheet), yawn_front_idle_anim_pointers 
	dw BANK(yawn_front_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_front_right_spritesheet), yawn_front_right_idle_anim_pointers
	dw BANK(yawn_front_right_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_right_spritesheet), yawn_right_idle_anim_pointers
	dw BANK(yawn_right_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_back_right_spritesheet), yawn_back_right_idle_anim_pointers
	dw BANK(yawn_back_right_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_back_spritesheet), yawn_back_idle_anim_pointers
	dw BANK(yawn_back_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_back_left_spritesheet), yawn_back_left_idle_anim_pointers
	dw BANK(yawn_back_left_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_left_spritesheet), yawn_left_idle_anim_pointers
	dw BANK(yawn_left_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_front_left_spritesheet), yawn_front_left_idle_anim_pointers
	dw BANK(yawn_front_left_spritesheet), yawn_right_attack_anim_pointers
;walk
	dw BANK(yawn_front_spritesheet), yawn_front_idle_anim_pointers
	dw BANK(yawn_front_spritesheet), yawn_right_attack_anim_pointers
	dw BANK(yawn_front_right_spritesheet), yawn_front_right_idle_anim_pointers
...
;attack
	...
	dw BANK(yawn_front_spritesheet), yawn_right_dead_anim_pointers
	dw BANK(yawn_front_right_spritesheet), yawn_front_right_attack_anim_pointers
	dw BANK(yawn_front_right_spritesheet), yawn_right_dead_anim_pointers
	dw BANK(yawn_right_spritesheet), yawn_right_attack_anim_pointers
	...
	dw BANK(yawn_back_right_spritesheet), yawn_right_dead_anim_pointers
	dw BANK(yawn_back_spritesheet), yawn_back_attack_anim_pointers
	dw BANK(yawn_back_spritesheet), yawn_right_dead_anim_pointers
	dw BANK(yawn_back_left_spritesheet), yawn_back_left_attack_anim_pointers
	dw BANK(yawn_back_left_spritesheet), yawn_right_dead_anim_pointers
	dw BANK(yawn_left_spritesheet), yawn_left_attack_anim_pointers
	dw BANK(yawn_left_spritesheet), yawn_right_dead_anim_pointers
	dw BANK(yawn_front_left_spritesheet), yawn_front_left_attack_anim_pointers
	dw BANK(yawn_front_left_spritesheet), yawn_right_dead_anim_pointers
;dead
	dw BANK(yawn_front_spritesheet), yawn_front_dead_anim_pointers
	dw BANK(yawn_front_spritesheet), yawn_right_dead_anim_pointers+16
	dw BANK(yawn_front_right_spritesheet), yawn_front_right_dead_anim_pointers
	dw BANK(yawn_front_right_spritesheet), yawn_right_dead_anim_pointers+16
	dw BANK(yawn_right_spritesheet), yawn_right_dead_anim_pointers
	dw BANK(yawn_right_spritesheet), yawn_right_dead_anim_pointers+16
	dw BANK(yawn_back_right_spritesheet), yawn_back_right_dead_anim_pointers
	dw BANK(yawn_back_right_spritesheet), yawn_right_dead_anim_pointers+16
	dw BANK(yawn_back_spritesheet), yawn_back_dead_anim_pointers
	dw BANK(yawn_back_spritesheet), yawn_right_dead_anim_pointers+16
	dw BANK(yawn_back_left_spritesheet), yawn_back_left_dead_anim_pointers
	dw BANK(yawn_back_left_spritesheet), yawn_right_dead_anim_pointers+16
	dw BANK(yawn_left_spritesheet), yawn_left_dead_anim_pointers
	dw BANK(yawn_left_spritesheet), yawn_right_dead_anim_pointers+16
	dw BANK(yawn_front_left_spritesheet), yawn_front_left_dead_anim_pointers
	dw BANK(yawn_front_left_spritesheet), yawn_right_dead_anim_pointers+16
;694B
